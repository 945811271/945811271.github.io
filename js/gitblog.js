var gitblog = function(config) {
    ...
    var Footer = function() {
        ...
        this.icons = [];
        this.icon_num = 0;
        this.content = 'Powered by <a href="https://github.com/945811271/chenhui.github.io" target="_blank" style="color: aquamarine;text-decoration:none;border-bottom: 1px solid #79f8d4;">gitblog</a>';
    }
    ...
    console.log('\n' + ' %c Gitblog' + ' %c https://github.com/945811271/chenhui.github.io \n', 'color: #fadfa3; background: #030307; padding:5px 0;', 'background: #fadfa3; padding:5px 0;');
}
